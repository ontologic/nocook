 ...
 * @author Aaron Loes
 */
$.fn.dataTableExt.oApi.fnExportRecords = function(oSettings, export_type) {
	
	if (oSettings.oFeatures.bServerSide) {
		
		var aoData = this.oApi._fnAjaxParameters(oSettings);
		
		aoData.push( { "name": "export_type", "value": export_type } );
		
		//call the url to export records
		$.ajax({
			type: "GET",
			...
			success: function(responseJSON){
				if (responseJSON.file) {
					document.location.href = base_url + 'download.php?file='+responseJSON.file;
				} else {
					location.reload();
				}
