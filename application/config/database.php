...
$db['staging']['hostname'] = 'stagging.ontologicsolutions.com';
$db['staging']['username'] = 'industrial_mysql';
$db['staging']['password'] = '1industrial1,';
$db['staging']['database'] = 'nocook';
